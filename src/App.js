...
function News({ newsList }) {
  return <NewsCarousel newsList={newsList} />;
}

function Movies({ movies, setmovies, text, score }) {
  return <MovieList movies={movies} setmovies={setmovies} text={text} score={score} />;
}

function Series({ series, setSeries }) {
  return <SerieList series={series} setSeries={setSeries} />;
}
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/movies" element={<Movies movies={movies} setmovies={setmovies} text={text} score={score} />} />
